...
Config.init = function ()
{
    ...
    Config.receiveHostSetting = prefs.getStringSetting ('Host', 'Receive from', 15, '127.0.0.1');
    ...
    Config.receivePortSetting = prefs.getNumberSetting ('Port', 'Receive from', 0, 65535, 1, '', 8000);
